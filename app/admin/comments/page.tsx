export default function AdminCommentsPage() {
  return <AdminList title="Comments Moderation" items={["Pin helpful instructor reply", "Delete spam comment", "Reply to student question", "Review reported discussion"]} />;
}
